...
while True:
    if i==0:
        ...
        blob_name=('ghi-du-lieu/fastergc-chan.jpg')
        download_bucket(path_to_file, blob_name)
        # image=Image.open('abc/a.jpg')
        frame = cv2.imread('ghi-du-lieu/fastergc-chan.jpg')
        frame_expanded = np.expand_dims(frame, axis=0)

    if i==1:
        path_to_file=('image_input/le.jpg')
        blob_name=('ghi-du-lieu/fastergc-le.jpg')
        download_bucket(path_to_file, blob_name)
        # image=Image.open('abc/a1.jpg')
        frame = cv2.imread('ghi-du-lieu/fastergc-le.jpg')		
        frame_expanded = np.expand_dims(frame, axis=0)
    ...
    cv2.imwrite('ghi-du-lieu/fastergc-out.jpg', frame)
    path_to_file1= 'ghi-du-lieu/fastergc-out.jpg'
