...
class ssdiu(QDialog):
    def __init__(self):
        super (ssdiu,self).__init__()
        loadUi('ssdiu.ui',self)
        self.image=None
        self.frame=None
    ...
    def loadhinh(self):
        ...
        cv2.imshow("Single Shot Mutil Detector", frame)
if __name__=='__main__':
    app=QApplication(sys.argv)
    window=ssdiu()
    window.setWindowTitle('SSD design by Nguyen Ngoc Duy')
    window.show()
    sys.exit(app.exec_())